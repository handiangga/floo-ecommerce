...
export default function OrdersPage() {
  ...
  useEffect(() => { if (!localStorage.getItem("access_token")) { router.replace("/login?next=/orders"); return; } OrderService.getMyOrders().then((result) => setOrders(result.data ?? [])).catch(() => setOrders([])); }, [router]);
